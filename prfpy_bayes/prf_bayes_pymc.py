...
class BayesPRFPyMC(TSPlotter):
    ...
    def initialise_walkers(self, idx, n_walkers, **kwargs):
        ...
        if init_walker_method == "random_prior":
            ...
            walker_start = self.init_walker_grid(n_walkers=n_walkers, idx=idx, **kwargs)
        print(walker_start.shape)
    ...
    def init_walker_grid(self, n_walkers, idx, **kwargs):
        ...
        walker_start = np.array(walker_start).reshape(self.n_params2fit, -1).T
        return walker_start
